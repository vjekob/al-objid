 ...
 */
export class LogicalObjectTypeRangesNode extends AppPoolAwareDescendantNode {
    ...
    constructor(parent: AppPoolAwareNode, objectType: string, name: string, ranges: NinjaALRange[]) {
        super(parent);
